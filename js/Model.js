...
let bookLeftSide = document.getElementById('left');
let bookRightSide = document.getElementById("right");
let bookstate = false;
let adjectiver = ["hestpeis", "Hestkuk", "Riv kjæft", "På fetthåret", "Ballhest ", "Jævles", "Tykjepelk ", "Fettoter ", "Baillhånka", "Bontjyv ", "Hæsblæsete ", "Håsslæsta ", "Jeggelaktig", "Søvvestpeising ", "Tøvkuk",
